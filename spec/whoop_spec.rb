...
RSpec.describe Whoop do
  ...
  describe ".whoop" do
    ...
    #     expect(logged_message).to include("Unsupported format used. Available formats: plain, pretty, json, sql, and trace")
    #   end
    # end
    ...
    context "when tracing" do
      it "writes to the logger" do
        ...
        whoop("Tracing Example", trace_events: %i[call]) { 
          bird = Animal::Bird.new
          bird.speak
        }
